...
function mobileModal() {
    ...
    $('.craigslist_2 .project .list-items .location .location-style .nav .nav-item .mmap').on('click', function() {
        $('.craigslist_2 .map-mobile').slideDown()
    })
    $('.craigslist_2 .project .list-items .location .location-style .nav .nav-item .mfilter').on('click', function() {
